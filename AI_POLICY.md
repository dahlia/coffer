...
The Coffer project has the following rules for AI usage:
...
These rules apply only to outside contributions to Coffer.  Maintainers are
...
Please remember that Coffer is maintained by humans.
...
Coffer is written with plenty of AI assistance, and many maintainers embrace
